...
class BetterDictionary {
  ...
  constructor(wordsArray) {
    const wordMap = wordsArray.reduce((accumulator, word) => {
      ...
      wordMap.split("").forEach((letter, i) => {
...
// Maybe use a character map that acutally includes star characters all the way through bc this would still be complexity O(1) lookup
